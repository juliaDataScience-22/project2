...
enet_pred <- predict(enet_model, newdata = testing_data)
...
evaluation_metrics <- data.frame(
  ...
  MAPE = c(mape_ols, mape_pls, mape_enet, mape_rf, mape_cubist, mape_svm, mape_cubist_tuned),
  RMSE = c(rmse_ols, rmse_pls, rmse_enet, rmse_rf, rmse_cubist, rmse_svm, rmse_cubist_tuned)
)
